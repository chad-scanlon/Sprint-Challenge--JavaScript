...
zooAnimals.forEach(animal => {
    let animalNames = `${animal.animal_name}, ${animal.scientific_name}`;
    displayNames.push(animalNames);
})
...
*/
const lowPopulationAnimals = zooAnimals.filter(function(animalPop) {
    if (animalPop.population < 5) {
        return true;
    }
})
